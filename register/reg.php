...
<body>
	...
	<div class = "reg">
		<form action="index.php" method = "POST" enctype="multipart/form-data">
			...
			Select profile image: <input name = "profile_pic" type = "file" /><br/><br/>
			...
			<input name = "conf-password" type = "password" placeholder = "Confirm Password" class="reg_input" /><br/><br/><br/>
